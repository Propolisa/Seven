 ...
 * @property {HtbMaker} maker - An object containing the id and name of the primary maker.
 * @property {HtbMaker} maker2 - An object containing the id and name of the secondary maker (if applicable).
...
class HtbMachine {
     ...
     * @param {HtbMaker} maker
     * @param {HtbMaker} maker2
     * @param {string} os
     * @param {string} ip
     * @param {number} rating
...
module.exports = {
	HtbMachine: HtbMachine,
	HtbChallenge: HtbChallenge,
